...
public const string DISCO_MODE_SETTINGS_KEY = "disco-mode";
...
public const string TOROIDAL_SETTINGS_KEY = "toroidal";
...
public class Preferences : Object
{
    ...
    public bool disco_mode { get; set; }
    ...
    public Preferences(Settings settings)
    {
        ...
        settings.bind (TOROIDAL_SETTINGS_KEY, this, "toroidal", SettingsBindFlags.DEFAULT);
